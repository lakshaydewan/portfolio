export default function BIOGRAPHY() {
    ...
    <div className='ml-4 font-medium text-lg text-[#987750]'>
        ...
        <div className='flex'>
            ...
            <div className='w-80 h-44 border-2 border-[#2f2e2c] bg-[#1d1b19] hover:border-[#987750] flex items-center justify-center mt-8 ml-28'>
            <a href="">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-12 h-12 text-white transition-transform duration-500 transform hover:-translate-y-1 animate-ping-infinite">
